...
### Annual_Bonus_: Bonus 
### Interaction :feature between annual bonus and training hours.
### Employee_Turnover (Target) : 1 = Employee Left, 0 = Stayed

## ➡ Model Description 
### Used Logistic Regression Algorithms  With Added Penalty like L1,L2 regularization and Different HyperParameter to Get the Optimize Metrics Score 
### Coded Some FeatureEngineering By adding Suitable Features 
